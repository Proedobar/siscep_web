...
<div class="procuradores-view">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6 mb-3">
            <div class="card h-100 theme-card">
                <div class="card-header py-3 bg-transparent">
                    <h5 class="mb-0 fw-bold text-center">Nombre del Procurador</h5>
                </div>
                <div class="card-body d-flex align-items-center justify-content-center">
                    <h3 class="mb-0 text-center"><?= Html::encode($model->nombre) ?></h3>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-3">
            <div class="card h-100 theme-card">
                ...
                <div class="card-body d-flex align-items-center justify-content-center">
                    <h3 class="mb-0"><?= Yii::$app->formatter->asDate($model->fecha_resolucion, 'dd/MM/yyyy') ?></h3>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-3">
            <div class="card h-100 theme-card">
                ...
                <div class="card-body d-flex align-items-center justify-content-center">
                    <h3 class="mb-0"><?= Yii::$app->formatter->asDate($model->fecha_gaceta, 'dd/MM/yyyy') ?></h3>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-3">
            <div class="card h-100 theme-card">
                ...
                <div class="card-body d-flex align-items-center justify-content-center">
                    <img src="data:image/png;base64,<?= $model->firma_base64 ?>" alt="Firma del Procurador" class="img-fluid" style="max-height: 100px;">
                </div>
            </div>
        </div>
        <?php endif; ?>
