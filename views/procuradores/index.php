...
/** @var app\models\ProcuradoresSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = Yii::t('app', 'Procuradores');
...
<div class="procuradores-index">
    ...
    <div class="row">
        <!-- Tarjeta para crear nuevo procurador -->
            ...
            <div class="col-lg-4 col-md-6 mb-3">
                <div class="card h-100 theme-card">
                    <div class="card-header py-3 bg-transparent">
                        <h5 class="mb-0 fw-bold text-center director-name"><?= Html::encode($model->nombre) ?></h5>
                    </div>
