...
/** @var app\models\BlockedIpsSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = Yii::t('app', 'IPs Bloqueadas');
...
<div class="blocked-ips-index">
    ...
    <?php if ($dataProvider->getCount() === 0): ?>
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="card border-start border-soft-warning border-3 rounded-3 hover-shadow glow-warning">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <div class="icon-box bg-warning bg-opacity-10 rounded-circle p-3 me-3">
                                <i class="fas fa-exclamation-triangle text-warning"></i>
                            </div>
                            <h5 class="card-title fw-bold m-0">No hay registros</h5>
                        </div>
                        <p class="card-text fs-5 text-muted">No se encontraron IPs bloqueadas en el sistema.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-6 mb-3">
                    <div class="card h-100 theme-card">
                        <div class="card-header py-3 bg-transparent">
                            <h5 class="mb-0 fw-bold text-center director-name"><?= Html::encode($model->ip) ?></h5>
                        </div>
                        <div class="card-body py-2">
                            <div class="mb-1">
                                <small class="text-secondary">Fecha de bloqueo:</small>
                                <span class="ms-1"><?= Html::encode($model->fecha_hora_bloqueo) ?></span>
                            </div>
                        </div>
...
.border-soft-warning {
    border-color: rgba(255, 193, 7, 0.68) !important;
}
