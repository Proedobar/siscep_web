    ...
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="text-align: center; margin-bottom: 30px;">
            <div style="margin-bottom: 15px;">
                <img src="<?= Yii::$app->params['baseUrl'] ?>/logo.png" alt="Logo" style="max-width: 150px; height: auto;">
            </div>
            <div style="font-size: 20px; font-weight: bold; color: #2c3e50; margin-bottom: 5px;">PROCURADURIA GENERAL DEL ESTADO BARINAS</div>
            <div style="font-size: 16px; color: #777;">Sistema de Constancias y Emisión de Pagos - SISCEP</div>
        </div>
